/**
 * Script para actualizar los passwords hasheados en producción
 * Ejecutar después de seed-production.sql
 * 
 * Ejecutar con: npx tsx scripts/update-passwords-production.ts
 */
...
async function generatePasswordUpdates() {
  ...
  console.log('\n💡 Copia y ejecuta estas queries en la base de datos de producción');
  console.log('   O usa: wrangler d1 execute coparenting-db-prod --remote --command="QUERY"');
}
